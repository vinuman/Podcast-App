...
const Header = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center py-[2.5rem] px-8">
        <div className="absolute w-[90%] border sm:w-[800px] h-[150px] mx-auto bg-blue blur-[100px] top-[-90px]"></div>
